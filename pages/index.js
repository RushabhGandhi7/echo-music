...
import { Music, Music2, Upload as UploadIcon, Play, Pause } from 'lucide-react';
            ...
            >
              {!isSpotifyConnected ? (
                <div className="text-center py-20">
                  <Music2 className="h-24 w-24 text-echo-primary/40 mx-auto mb-6" />
                  <h2 className="text-3xl font-bold text-echo-text mb-4">
                    Connect with Spotify
                  </h2>
                  <p className="text-lg text-echo-text-secondary mb-8 max-w-2xl mx-auto">
                  ...
                  <motion.button
                    onClick={handleSpotifyConnect}
                    className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 flex items-center space-x-3 mx-auto"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
